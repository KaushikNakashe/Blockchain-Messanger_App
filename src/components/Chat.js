...
class Chat extends Component {
    ...
    render() {
        return (
        <body>
            <center> <h1>Kaushik's Messanger💬</h1> </center>
                ...
                <div class="row">
                    <div class="col-7 left-block">
                        ...
                        <div class="footer-chat">
                            ...
                            <input value={this.state.inputValue} onChange={evt => this.updateInputValue(evt)} type="text" class="write-message" placeholder="Type a message..."></input>
                    ...
                    <div class="col-5 right-block">
                        <h3>Current Blockchain State:</h3>
